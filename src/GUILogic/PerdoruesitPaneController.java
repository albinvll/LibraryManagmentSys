...
//    RoliRepository rr = new RoliRepository();
    ...
    public void AddPictureButton(){
        ...
        String [] acceptableExtensions = {"*.jpg", "*.png"};
        
        FileChooser.ExtensionFilter imageFilter = new FileChooser.ExtensionFilter("Image Files", acceptableExtensions);
    ...
    private void RuajButton() {
        try{
            ...
            if(row==-1){
                ...
                String hashedName = hash(file.getName().substring(0,file.getName().lastIndexOf(".")).concat(p.getEmail()));
                ...
                p.setPassword(hash(Password_field.getText()));
